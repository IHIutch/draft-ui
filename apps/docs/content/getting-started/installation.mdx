...
```bash
npm install react-aria-components@1.0.0-beta.2 cva@beta tailwind-merge tailwindcss-animate tailwindcss-react-aria-components@1.0.0-beta.1
```

This project requires the following packages:

- [react-aria-components@1.0.0-beta.2](https://github.com/adobe/react-spectrum/tree/main/packages/react-aria-components)
