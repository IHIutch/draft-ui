...
```bash
npm install react-aria-components@1.0.0-beta.2 class-variance-authority clsx tailwind-merge tailwindcss-animate tailwindcss-react-aria-components@1.0.0-beta.1
```
